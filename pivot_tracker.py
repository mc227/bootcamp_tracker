...
A tkinter desktop app tracking the curated O'Reilly "Sep 2026" playlist
(17 courses). Ordered into three blocks:

  1. ARCHIVE  — courses completed/skipped BEFORE this list existed
                (Pythonic OOP, Protocol Buffers, and the Python Sockets
                material you finished). These are no longer on the playlist;
                they're kept only so your recorded progress stays intact.
  2. BLIND 75 (Sarda) — playlist item #1 and the current priority.
  3. REMAINING — the other 16 playlist courses, in playlist order.

The indices in pivot_progress.json match this order. Your completed/skipped
state (indices 0-77, all inside the archive block) is preserved unchanged;
only the remaining block and the total were rebuilt.
...
# Active blocks are prefixed with their position on the 17-item playlist
# (01-17). Archive sections are prefixed with a check mark; they predate
# the current list and carry no playlist number.
# ----------------------------------------------------------------------
CURRICULUM = [
    # ===================== ARCHIVE — completed/skipped before this list =====================
    # No longer on the "Sep 2026" playlist. Kept so your progress record (indices 0-77)
    # stays intact. The app's per-section counts show the done/skipped split; the leading
    # check just marks the block as archived.
    ('✓ Pythonic OOP (Maxwell)', [
    ...
    ('✓ Protocol Buffers 3 (Maarek) — Hands-on: Java', [
    ...
    ('✓ Protocol Buffers 3 (Maarek) — Hands-on: Go', [
    ...
    ('✓ Python Sockets (Eramo) — Setup & Networking', [
    ...
    # ===================== BLIND 75 (Sarda) — playlist #1, current priority =====================
    ...
    ('01 · Master DSA / Blind 75+ (Sarda) — Arrays & Hashing', [
    ...
    ('01 · Master DSA / Blind 75+ (Sarda) — Stack', [
        'Valid Parentheses (20)', 'Daily Temperatures (739)',
    ]),
    ('01 · Master DSA / Blind 75+ (Sarda) — Binary Search', [
        'Binary Search (704)', 'Find Minimum in Rotated Sorted Array (153)',
        'Search in Rotated Sorted Array (33)',
    ]),
    ('01 · Master DSA / Blind 75+ (Sarda) — Trees (DFS/BFS)', [
    ...
    ('01 · Master DSA / Blind 75+ (Sarda) — Backtracking', [
        'Combination Sum (39)', 'Word Search (79)',
    ]),
    ('01 · Master DSA / Blind 75+ (Sarda) — Tries', [
        'Implement Trie (208)', 'Add and Search Words Data Structure (211)',
        'Word Search II (212)',
    ]),
    ('01 · Master DSA / Blind 75+ (Sarda) — Heap / Priority Queue', [
        'Find Median from Data Stream (295)',
    ]),
    ('01 · Master DSA / Blind 75+ (Sarda) — Graphs', [
    ...
    ('01 · Master DSA / Blind 75+ (Sarda) — Dynamic Programming', [
    ...
    ('03 · Linux Networking & Security (Prowse) — Day 1: Networking', [
    ...
    ('03 · Linux Networking & Security (Prowse) — Day 2: Security', [
    ...
    ('04 · Docker for Developers 2026 — Microservices Workshop (Kocherhin)', [
    ...
    ('05 · Concurrency in Python (Prasad)', [
    ...
    ('07 · Microservices Bootcamp (Newman)', [
    ...
    ('08 · Python: Beyond the Basics (Maxwell)', [
    ...
    ('09 · Beyond Python Scripts — Logging, Modules & Dependencies (Maxwell)', [
    ...
    ('10 · Beyond Python Scripts — Exceptions, Error Handling & CLIs (Maxwell)', [
    ...
    ('13 · Scaling Python with Generators (Maxwell)', [
    ...
    ('14 · Python: The Next Level (Maxwell)', [
    ...
    ('15 · Coding Interview Bootcamp (Bhardwaj)', [
    ...
    ('16 · System Design Interview Boot Camp (Bhardwaj)', [
    ...
    ('17 · Computer Architecture with Python & ARM (Clements) — Part 1: Simulating a Computer', [
    ...
    ('17 · Computer Architecture with Python & ARM (Clements) — Part 2: Raspberry Pi & ARM', [
